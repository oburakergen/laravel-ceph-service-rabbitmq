...
class RabbitMQService
{
    ...
    public function __construct(AMQPStreamConnection $connection, protected LicenseRepository $licenseRepository)
    {
    ...
    public function createUserMessages(): void
    {
        $callback = function (AMQPMessage $msg) {
            $license = $this->licenseRepository->create(['user_id' => $msg->body]);

            $this->sendMessage('object_storage_queue', json_encode($license->toArray()));
        };
